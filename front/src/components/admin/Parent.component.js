...
export default function() {
    ...
    React.useEffect(()=>{
        axios.get('http://localhost:5000/users/parent').then(res => {
            setParents(res.data);
    }).catch(err => {
        console.log(err);
    })
    ...
    return (
        ...
        <Table rows={columns} data={parents} rowSelectionModel={rowSelectionModel} setRowSelectionModel={setRowSelectionModel}/>
        <BootstrapDialog
